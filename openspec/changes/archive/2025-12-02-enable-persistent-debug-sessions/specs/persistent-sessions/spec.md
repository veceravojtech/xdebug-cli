...
## Purpose
Enables debug sessions to persist in the background, allowing multiple CLI invocations to interact with the same active debug session without severing the PHP connection.
